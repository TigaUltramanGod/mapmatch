        ...
        BaseBidirectionalShortestPathAlgorithm<V, E>
{
    ...
    {
        return new org.jgrapht.alg.shortestpath.BidirectionalDijkstraShortestPath<>(graph).getPath(source, sink);
    }
     ...
     * @param <E> edges type
     */
    public static class DijkstraSearchFrontier<V, E>
            extends
            BaseSearchFrontier<V, E>
    {

        public final AddressableHeap<Double, Pair<V, E>> heap;
        public final Map<V, AddressableHeap.Handle<Double, Pair<V, E>>> seen;
        public boolean isFinished;

        public DijkstraSearchFrontier(
                Graph<V, E> graph, Supplier<AddressableHeap<Double, Pair<V, E>>> heapSupplier)
        {
            super(graph);
