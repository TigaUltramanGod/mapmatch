...
//                tempDist = otherFrontier.heap.findMin().getKey();
//            }
            if (frontier.heap.findMin().getKey() + tempDist >= bestPath) {
                frontier.isFinished = true;
            } else {
     ...
     * @param <E> edges type
     */
    public static class ContractionSearchFrontier<V, E>
            extends
            DijkstraSearchFrontier<V, E>
    {
         ...
         */
        public ContractionSearchFrontier(
