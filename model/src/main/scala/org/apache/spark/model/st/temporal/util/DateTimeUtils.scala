package org.apache.spark.model.st.temporal.util
...
object DateTimeUtils {
  implicit def convert2JustTimestamp(time: Timestamp): Long = {
    time.getNanos / 1000L
  }

  // we use Int and Long internally to represent [[DateType]] and [[TimestampType]]
  type JustDate = Int //unit is day
  type JustTimestamp = Long //unit is microseconds

  // see http://stackoverflow.com/questions/466321/convert-unix-timestamp-to-julian
  // it's 2440587.5, rounding up to compatible with Hive
  final val JULIAN_DAY_OF_EPOCH = 2440588
  final val SECONDS_PER_HOUR = 60 * 60
  ...
  private val threadLocalTimestampFormat: ThreadLocal[DateFormat] = new ThreadLocal[DateFormat] {
  ...
  // `SimpleDateFormat` is not thread-safe.
  private val threadLocalDateFormat: ThreadLocal[DateFormat] = new ThreadLocal[DateFormat] {
    override def initialValue(): SimpleDateFormat = {
  ...
  def newDateFormat(formatString: String, timeZone: TimeZone): DateFormat = {
    val sdf = new SimpleDateFormat(formatString, Locale.CHINESE)
    sdf.setTimeZone(timeZone)
  ...
  def millisToDays(millisUtc: Long): JustDate = {
    millisToDays(millisUtc, defaultTimeZone())
  }

  def millisToDays(millisUtc: Long, timeZone: TimeZone): JustDate = {
  ...
  def daysToMillis(days: JustDate): Long = {
    daysToMillis(days, defaultTimeZone())
  }

  def daysToMillis(days: JustDate, timeZone: TimeZone): Long = {
    val millisLocal = days.toLong * MILLIS_PER_DAY
    millisLocal - getOffsetFromLocalMillis(millisLocal, timeZone)
  }

  def dateToString(days: JustDate): String =
    getThreadLocalDateFormat.format(toJavaDate(days))

  // Converts Timestamp to string according to Hive TimestampWritable convention.
  def timestampToString(us: JustTimestamp): String = {
    timestampToString(us, defaultTimeZone())
  }

  // Converts Timestamp to string according to Hive TimestampWritable convention.
  def timestampToString(us: JustTimestamp, timeZone: TimeZone): String = {
  ...
  /**
    ...
    */
  def fromJavaDate(date: Date): JustDate = {
  ...
  /**
    ...
    */
  def toJavaDate(daysSinceEpoch: JustDate): Date = {
  ...
  /**
    ...
    */
  def toJavaTimestamp(us: JustTimestamp): Timestamp = {
  ...
  /**
    ...
    */
  def fromJavaTimestamp(t: Timestamp): JustTimestamp = {
    if (t != null) {
  ...
  /**
    ...
    */
  def fromJulianDay(day: Int, nanoseconds: Long): JustTimestamp = {
  ...
  /**
    ...
    */
  def toJulianDay(us: JustTimestamp): (Int, Long) = {
   ...
   */
  def toMillis(us: JustTimestamp): Long = {
   ...
   */
  def fromMillis(millis: Long): JustTimestamp = {
    millis * 1000L
  }
  ...
  /**
    ...
    * `T[h]h:[m]m:[s]s.[ms][ms][ms][us][us][us]+[h]h:[m]m`
    */
  def stringToTimestamp(s: String): Option[JustTimestamp] = {
    stringToTimestamp(s, defaultTimeZone())
  }

  def stringToTimestamp(s: String, timeZone: TimeZone): Option[JustTimestamp] = {
    if (s == null) {
      return None
    }
  ...
  /**
    ...
    * `yyyy-[m]m-[d]dT*`
    */
  def stringToDate(s: String): Option[JustDate] = {
    if (s == null) {
      return None
    }
  ...
  /**
    ...
    */
  private def absoluteMicroSecond(microsec: JustTimestamp): JustTimestamp = {
    microsec + toYearZero * MICROS_PER_DAY
  }

  private def localTimestamp(microsec: JustTimestamp): JustTimestamp = {
    localTimestamp(microsec, defaultTimeZone())
  }

  private def localTimestamp(microsec: JustTimestamp, timeZone: TimeZone): JustTimestamp = {
  ...
  /**
    ...
    */
  def getHours(microsec: JustTimestamp): Int = {
  ...
  /**
    * Returns the hour value of a given timestamp value. The timestamp is expressed in microseconds.
    */
  def getHours(microsec: JustTimestamp, timeZone: TimeZone): Int = {
  ...
  /**
    ...
    * microseconds.
    */
  def getMinutes(microsec: JustTimestamp): Int = {
  ...
  /**
    ...
    * microseconds.
    */
  def getMinutes(microsec: JustTimestamp, timeZone: TimeZone): Int = {
  ...
  /**
    ...
    * microseconds.
    */
  def getSeconds(microsec: JustTimestamp): Int = {
  ...
  /**
    ...
    * microseconds.
    */
  def getSeconds(microsec: JustTimestamp, timeZone: TimeZone): Int = {
  ...
  /**
    ...
    */
  private[this] def getYearAndDayInYear(daysSince1970: JustDate): (Int, Int) = {
  ...
  /**
    ...
    * since 1.1.1970.
    */
  def getDayInYear(date: JustDate): Int = {
  ...
  /**
    ...
    * since 1.1.1970.
    */
  def getQuarter(date: JustDate): Int = {
  ...
  /**
    ...
    */
  def splitDate(date: JustDate): (Int, Int, Int, Int) = {
    var (year, dayInYear) = getYearAndDayInYear(date)
  ...
  /**
    ...
    */
  def getMonth(date: JustDate): Int = {
    var (year, dayInYear) = getYearAndDayInYear(date)
    if (isLeapYear(year)) {
      if (dayInYear == 60) {
        return 2
  ...
  /**
    ...
    * since 1.1.1970.
    */
  def getDayOfMonth(date: JustDate): Int = {
    var (year, dayInYear) = getYearAndDayInYear(date)
    if (isLeapYear(year)) {
      if (dayInYear == 60) {
        return 29
  ...
  /**
    ...
    */
  private def firstDayOfMonth(absoluteMonth: Int): JustDate = {
  ...
  /**
    ...
    */
  private def getDateFromYear(absoluteYear: Int): JustDate = {
  ...
  /**
    ...
    */
  def dateAddMonths(days: JustDate, months: Int): JustDate = {
  ...
  /**
    ...
    */
  def timestampAddInterval(start: JustTimestamp, months: Int, microseconds: Long): JustTimestamp = {
  ...
  def timestampAddInterval(
                            ...
                            months: Int,
                            microseconds: Long,
                            timeZone: TimeZone): JustTimestamp = {
  ...
  /**
    ...
    * 8 digits.
    */
  def monthsBetween(time1: JustTimestamp, time2: JustTimestamp): Double = {
  ...
  /**
    ...
    * 8 digits.
    */
  def monthsBetween(time1: JustTimestamp, time2: JustTimestamp, timeZone: TimeZone): Double = {
  ...
  /**
    ...
    */
  def getNextDateForDayOfWeek(startDate: JustDate, dayOfWeek: Int): JustDate = {
  ...
  /**
    ...
    * since 1.1.1970.
    */
  def getLastDayOfMonth(date: JustDate): JustDate = {
    val (_, _, _, daysToMonthEnd) = splitDate(date)
    date + daysToMonthEnd
  }

  // Visible for testing.
  private[temporal] val TRUNC_TO_YEAR = 1
  private[temporal] val TRUNC_TO_MONTH = 2
  private[temporal] val TRUNC_TO_QUARTER = 3
  private[temporal] val TRUNC_TO_WEEK = 4
  private[temporal] val TRUNC_TO_DAY = 5
  private[temporal] val TRUNC_TO_HOUR = 6
  private[temporal] val TRUNC_TO_MINUTE = 7
  private[temporal] val TRUNC_TO_SECOND = 8
  private[temporal] val TRUNC_INVALID = -1

  /**
    * Returns the trunc date from original date and trunc level.
    * Trunc level should be generated using `parseTruncLevel()`, should only be 1 or 2.
    */
  def truncDate(d: JustDate, level: Int): JustDate = {
  ...
  /**
    ...
    */
  def truncTimestamp(t: JustTimestamp, level: Int, timeZone: TimeZone): JustTimestamp = {
  ...
  def truncTimestamp(d: JustTimestamp, level: Int): JustTimestamp = {
  ...
  /**
    ...
    */
  private[temporal] def getOffsetFromLocalMillis(millisLocal: Long, tz: TimeZone): Long = {
  ...
  /**
    ...
    * timezone-aware.
    */
  def convertTz(ts: JustTimestamp, fromZone: TimeZone, toZone: TimeZone): JustTimestamp = {
  ...
  /**
    ...
    */
  def fromUTCTime(time: JustTimestamp, timeZone: String): JustTimestamp = {
  ...
  /**
    ...
    */
  def toUTCTime(time: JustTimestamp, timeZone: String): JustTimestamp = {
